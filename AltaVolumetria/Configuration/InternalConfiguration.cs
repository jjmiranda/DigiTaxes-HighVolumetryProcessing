...
namespace Configuration
{
    ...
    {
        private static string ApplicationId = "[yourApplicationId]";
        private static string ApplicationKey = "[yourApplicationKey]";
        private static string KeyVaultAddress = "https://[yourKeyVaultAddress].vault.azure.net/";
